...
public class ExprParser extends Parser {
	...
	public static final int
		LP=1, RP=2, LSB=3, RSB=4, PLUS=5, MINUS=6, STAR=7, SLASH=8, COLON=9, COMMA=10, 
		INT=11, ID=12, WS=13, FLOAT=14;
	public static final String[] tokenNames = {
		"<INVALID>", "'('", "')'", "'['", "']'", "'+'", "'-'", "'*'", "'/'", "':'", 
		"','", "INT", "ID", "WS", "FLOAT"
	};
	public static final int
		RULE_expr_ = 0, RULE_expr = 1, RULE_valueRange = 2, RULE_valueList = 3;
	public static final String[] ruleNames = {
		"expr_", "expr", "valueRange", "valueList"
	};
	...
	public static class Expr_Context extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitExpr_(this);
	...
	public static class FloatValueContext extends ExprContext {
		...
		public FloatValueContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitFloatValue(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IndexedVarContext extends ExprContext {
		public TerminalNode RSB() { return getToken(ExprParser.RSB, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode ID() { return getToken(ExprParser.ID, 0); }
		public TerminalNode LSB() { return getToken(ExprParser.LSB, 0); }
		public IndexedVarContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitIndexedVar(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IntValueContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitIntValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(12); match(LP);
				setState(13); valueList();
				setState(14); match(RP);
				}
				break;
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(16); match(LP);
				setState(17); expr(0);
				setState(18); match(RP);
				}
				break;
			...
			case 3:
				...
				setState(21); match(LSB);
				setState(22); expr(0);
				setState(23); match(RSB);
				}
				break;
	...
	public static class ValueRangeContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitValueRange(this);
			else return visitor.visitChildren(this);
		}
	}
